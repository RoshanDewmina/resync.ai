...
//   maxProjects: number | null; // Maximum number of projects allowed
//   maxIntegrationsPerProject: number | null; // Maximum number of integrations per project
//   maxQuestionsPerMonth: number | null; // Maximum number of questions allowed per month
//   maxTokens: number | null; // Maximum number of tokens allowed
//   maxStorageGB: number | null; // Maximum storage in GB
//   gptModel: string | string[]; // Allowed GPT model versions
// }

// // Privileges configuration based on plan types
// const privileges: Record<PlanType, PlanPrivileges> = {
//   Trial: {
//     maxProjects: 1,
